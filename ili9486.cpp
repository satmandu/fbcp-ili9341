...
void InitILI9486()
{
  ...
  BEGIN_SPI_COMMUNICATION();
  {
    ...
    SPI_TRANSFER(0xC2/*Power Control 3*/, 0x00, 0x44);
    SPI_TRANSFER(0xC5/*VCOM Control*/, 0x00, 0x00, 0x00, 0x00);
#else
    SPI_TRANSFER(0xC0/*Power Control 1*/, 0x09, 0x09);
    SPI_TRANSFER(0xC1/*Power Control 2*/, 0x41, 0x00);
    SPI_TRANSFER(0xC2/*Power Control 3*/, 0x44);
    SPI_TRANSFER(0xC5/*VCOM Control*/, 0x00, 0x00);
#endif
...
#define MADCTL_ROTATE_180_DEGREES (MADCTL_COLUMN_ADDRESS_ORDER_SWAP | MADCTL_ROW_ADDRESS_ORDER_SWAP)
    ...
    SPI_TRANSFER(0xE0/*Positive Gamma Control*/, 0x00, 0x0F, 0x00, 0x1F, 0x00, 0x1C, 0x00, 0x0C, 0x00, 0x0F, 0x00, 0x08, 0x00, 0x48, 0x00, 0x98, 0x00, 0x37, 0x00, 0x0A, 0x00, 0x13, 0x00, 0x04, 0x00, 0x11, 0x00, 0x0D, 0x00, 0x00);
    SPI_TRANSFER(0xE1/*Negative Gamma Control*/, 0x00, 0x0F, 0x00, 0x32, 0x00, 0x2E, 0x00, 0x0B, 0x00, 0x0D, 0x00, 0x05, 0x00, 0x47, 0x00, 0x75, 0x00, 0x37, 0x00, 0x06, 0x00, 0x10, 0x00, 0x03, 0x00, 0x24, 0x00, 0x20, 0x00, 0x00);
    ...
    SPI_TRANSFER(0xE0/*Positive Gamma Control*/, 0x0F, 0x1F, 0x1C, 0x0C, 0x0F, 0x08, 0x48, 0x98, 0x37, 0x0a, 0x13, 0x04, 0x11, 0x0D, 0x00);
    SPI_TRANSFER(0xE1/*Negative Gamma Control*/, 0x0F, 0x32, 0x2E, 0x0B, 0x0D, 0x05, 0x47, 0x75, 0x37, 0x06, 0x10, 0x03, 0x24, 0x20, 0x00);
